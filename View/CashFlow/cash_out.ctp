...
<div class="row">
    <div class="navbar-form">
        <div class="navbar-btn navbar-left">
            <?php echo $this->Html->link('Добавить','add_cash_flow_out',array('class' => 'btn btn-success ajax-link'));?>
            <?php echo $this->Html->link('Выгрузка данных в EXCEL','export/out',array('class' => 'btn btn-info'));?>
            <?php echo $this->Html->link('Фильтр','#',array('class' => 'btn btn-info btn-cash-filter'));?>
        </div>
        <?php echo $this->element('search',array('search_view' => 'cash_out', 'class' => 'navbar-text')); ?>
    </div>
</div>
...
<table class='table table-hover table-striped table-bordered table-condensed'>
    <thead>
        <tr>
            ...
            <th><?php echo $this->Admin->PaginatorSort('cash','Расход (сумма)') ?></th>
            ...
            <th class="hidden-xs hidden-sm"><?php echo $this->Admin->PaginatorSort('Classificator.name','Классификация') ?></th>
    ...
    <?php
        foreach ($cash_out AS $cash)
        {
            echo $this->Html->TableCells(array(
                ...
                ,array($cash['Source']['name'],array('class'=>'hidden-xs hidden-sm'))
...
<script type="text/javascript">
    $(document).ready(function() {
        //$("#testt").webuiPopover({placement: 'auto'});
