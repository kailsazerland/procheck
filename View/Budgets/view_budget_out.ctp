...
<div class="row">
        <div id="breadcrumb" class="col-xs-12">
                <ol class="breadcrumb">
                        ...
                        <li><a href="#">Бюджет расходов</a></li>
                </ol>
        </div>
</div>
...
<div class="navbar-btn navbar-left page-header">
    <?php echo $this->Html->link('Копировать последнее','copy_budget_out',array('class' => 'btn btn-success ajax-link'));?>
    <?php echo $this->Html->link('Добавить','add_budget_out',array('class' => 'btn btn-success ajax-link'));?>
</div>        
    
<?php echo $this->element('search',array('search_view' => 'view_budget_out')); ?>   
</div>
