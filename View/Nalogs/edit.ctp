...
<div class="col-xs-12 col-sm-6">
    <div class="panel panel-default">
        ...
        <?php
            echo $this->Form->create('Nalog', array('url' => './save', 'class' => 'form', 'role' => 'form'));		
            echo $this->Form->input('Nalog.id',array('type' => 'hidden')); 
            echo $this->Form->input('Nalog.name',array('label' => 'Наименование'));           
            echo $this->Form->input('Nalog.percent',array('label' => 'Процент'));
