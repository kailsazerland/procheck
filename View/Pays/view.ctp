...
<?if($arch != 1){?>
<div class="row">
    <div id="export" class="col-xs-12" style="margin-bottom: 20px;margin-top: -42px;margin-left: 94px;">
        <?php echo $this->Form->submit('Выгрузить в банк',array('class' => 'btn btn-success','div' => false));
