...
<div class="col-xs-12 col-sm-6">
    <div class="panel panel-default">
        ...
        <?php
            echo $this->Form->create('Classificator', array('url' => './save', 'class' => 'form', 'role' => 'form'));		
            echo $this->Form->input('Classificator.id',array('type' => 'hidden')); 
            echo $this->Form->input('Classificator.type_id',array('type' => 'hidden')); 
            echo $this->Form->input('Classificator.name',array('label' => 'Наименование'));       
