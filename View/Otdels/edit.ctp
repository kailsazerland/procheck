...
<div class="col-xs-12 col-sm-6">
    <div class="panel panel-default">
        ...
        <?php
            echo $this->Form->create('Otdel', array('url' => './save', 'class' => 'form', 'role' => 'form'));		
            echo $this->Form->input('Otdel.id',array('type' => 'hidden')); 
            echo $this->Form->input('Otdel.name',array('label' => 'Наименование'));           
